...
const CourseContentMedia: FC<Props> = ({
  ...
  const { data: dataCourse, refetch: courseRefetch } =
    useGetUserCourseDetailQuery({ id }, { refetchOnMountOrArgChange: true });
      ...
      {activeBar === 3 && (
        <div className="w-full">
          <>
            ...
            <div className="w-full">
              {(
                dataCourse.course?.reviews &&
                [...dataCourse.course.reviews].reverse()
                  ...
                  {isReviewReply && reviewId === item._id && (
                    <div className="w-full flex relative dark:text-white text-black">
                      <input
                        ...
                        className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b border-[#000000027] dark:border-[#fff] text-black dark:text-white  p-[5px] w-[95%] ${
                          reviewReply === "" ||
                          (reviewReplyCreateLoading && "cursor-not-allowed")
                        }`}
                      />
                      <button
                        type="submit"
                        ...
                        disabled={
                          reviewReply === "" || reviewReplyCreateLoading
                        }
                      >
                        Submit
                      </button>
                    ...
                    <div className="w-full flex 800px:ml-16 my-5">
                      ...
                      <div className="pl-2">
                        <div className="flex items-center">
                          ...
                          <h5 className="text-[#d1001f] ml-2 text-[20px] capitalize italic drop-shadow-2xl">
                            {i.user.role === "user" ? "" : i.user.role}
                          </h5>
                        </div>
                        <p>{i.comment}</p>
        ...
        <div className="flex mb-2">
          ...
          <div className="pl-3 dark:text-white text-black">
            <div className="flex items-center">
              ...
              <h5 className="text-[#d1001f] ml-2 text-[20px] capitalize italic drop-shadow-2xl">
                {item.user.role === "user" ? "" : item.user.role}
              </h5>
            </div>
            <p>{item?.question}</p>
            <small className="dark:text-[#ffffff83] text-[#000000b0]">
              {format(item?.createdAt)}{" "}
            </small>
          </div>
        </div>
